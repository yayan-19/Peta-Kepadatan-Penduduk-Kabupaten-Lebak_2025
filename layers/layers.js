...
//ol.proj.get("EPSG:4326").setExtent([103.291489, -7.617992, 109.002389, -5.528741]);
var wms_layers = [];
...
lyr_KepadatanPendudukKabupatenLebakTahun2025_2.set('fieldLabels', {'fid': 'hidden field', 'Kecamatan': 'inline label - visible with data', 'Tahun': 'inline label - visible with data', 'jml_pend': 'inline label - visible with data', 'kepadatan_': 'inline label - visible with data', 'SexRatio_': 'inline label - visible with data', 'Laju_Pert': 'inline label - visible with data', });
