...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 1,
        extent: [103.291489, -7.617992, 109.002389, -5.528741],
        projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [105.862893, -6.999444, 106.526167, -6.290373],
            units: 'degrees'
        })
    })
});
...
map.getView().fit([103.291489, -7.617992, 109.002389, -5.528741], map.getSize());
