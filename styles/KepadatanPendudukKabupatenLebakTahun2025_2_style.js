...
var style_KepadatanPendudukKabupatenLebakTahun2025_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("kepadatan_");
    ...
    if (value >= 0.000000 && value <= 500.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2000.000000 && value <= 2239.000000) {
            style = [ new ol.style.Style({
